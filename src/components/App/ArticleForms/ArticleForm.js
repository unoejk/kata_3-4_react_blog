...
const ArticleForm = (props) => {
    ...
    const onSubmit = async (data) => {
        ...
        await props.submit(token, article)
            .then(() => {
                reset()
    ...
    return (
        <form className={style.articleForm} onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className={style.articleForm__controlPanel}>
                ...
                {tagsList.map((val, num) => (
                    <div className={classNames(style.articleForm__controlRow)} key={val.key}>
                        ...
                        <button
                            className={classNames(style.articleForm__controlBtn, style['articleForm__controlBtn--red'], {
                        ...
                        <button
                            className={classNames(style.articleForm__controlBtn, style['articleForm__controlBtn--blue'])}
                            onClick={(e) => addTag(e)}
                        >
                            Add tag
                        </button>
            ...
            <div className={style.articleForm__submitRow}>
                ...
                <p className={classNames(style.articleForm__errorMessage, { disabled: !isError })}>
                    {isError}
                </p>
            </div>
        </form>
